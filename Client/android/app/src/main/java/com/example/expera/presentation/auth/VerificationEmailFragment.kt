 ...
 * Use the [VerificationEmailFragment.newInstance] factory method to
...
class VerificationEmailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment VerificationEmailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            VerificationEmailFragment().apply {
