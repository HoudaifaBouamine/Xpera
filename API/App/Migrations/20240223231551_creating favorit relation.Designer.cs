...
namespace App.API.Migrations
{
    ...
    [Migration("20240223231551_creating favorit relation")]
    partial class creatingfavoritrelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Favorit", b =>
                {
                    b.HasOne("App.API.Models.PostModels.PostModel", null)
                        .WithMany()
                        .HasForeignKey("Post_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.API.Models.UserModel", null)
                        .WithMany()
                        .HasForeignKey("User_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
