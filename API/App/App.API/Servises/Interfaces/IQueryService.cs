...
namespace App.API.Servises.Interfaces
{
    public interface IQueryService
    {
        ...
        public Task<PostReadDto?> ReadPostAsync(int post_id);
        ...
        public Task<IEnumerable<PostReadDto>> ReadUserPostsAsync(int user_id);

        /// <summary>
        /// Get all the posts information in the system
        /// </summary>
        /// <returns>list of all the posts in the system</returns>
        public Task<IEnumerable<PostReadDto>> ReadAllPostsAsync();
        ...
        public Task<IEnumerable<PostReadDto>> ReadTagPostsAsync(int tag_id);
